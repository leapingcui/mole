                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <form action="${webRoot}/personController/insert.do" method="post">
                                        <table id="example1" class="table table-bordered table-striped">
                                            <tr>
                                                <th>人员编号</th>
                                                <td><input type="text" id="tPersonId" name="tPersonId"></td>
                                                <th>用户名</th>
                                                <td><input type="text" id="tPersonUsername" name="tPersonUsername"></td>
                                            </tr>
                                            <tr>
                                                <th>人员类型</th>
                                                <td><input type="text" id="tPersonType" name="tPersonType"></td>
                                                <th>真实姓名</th>
                                                <td><input type="text" id="tPersonTruename" name="tPersonTruename"></td>
                                            </tr>
                                            <tr>
                                                <th>性别</th>
                                                <td>
                                                ...
                                                <th>英文名</th>
                                                <td><input type="text" id="tPersonEnName" name="tPersonEnName"></td>
                                            </tr>
                                            <tr>
                                                <th>曾用名</th>
                                                <td><input type="text" id="tPersonNameUsed" name="tPersonNameUsed"></td>
                                                <th>电话号码</th>
                                                <td><input type="text" id="tPersonTelephone" name="tPersonTelephone"></td>
                                            </tr>
                                            <tr>
                                                <th>传真</th>
                                                <td><input type="text" id="tPersonFax" name="tPersonFax"></td>
                                                <th>地址</th>
                                                <td><input type="text" id="tPersonAddr" name="tPersonAddr"></td>
                                            </tr>
                                            <tr>
                                                <th>手机号</th>
                                                <td><input type="text" id="tPersonMobilephone" name="tPersonMobilephone"></td>
                                                <th>email</th>
                                                <td><input type="text" id="tPersonEmail" name="tPersonEmail"></td>
                                            </tr>
                                            <tr>
                                                <th>qq号</th>
                                                <td><input type="text" id="tPersonQq" name="tPersonQq"></td>
                                                <th>微信号</th>
                                                <td><input type="text" id="tPersonWetchat" name="tPersonWetchat"></td>
                                            </tr>
                                            <tr>
                                                <th>职务</th>
                                                <td><input type="text" id="tPersonDuty" name="tPersonDuty"></td>
                                                <th>职称</th>
                                                <td><input type="text" id="tPersonTitle" name="tPersonTitle"></td>
                                            </tr>
                                            <tr>
                                                <th>身份证号</th>
                                                <td><input type="text" id="tPersonIdentifyNum" name="tPersonIdentifyNum"></td>
                                                <th>出生日期</th>
                                                <td><input type="text" id="tPersonBirth" name="tPersonBirth"></td>
                                            </tr>
                                            <tr>
                                                <th>民族</th>
                                                <td><input type="text" id="tPersonNation" name="tPersonNation"></td>
                                                <th>最高学位</th>
                                                <td><input type="text" id="tPersonHighestDegree" name="tPersonHighestDegree"></td>
                                            </tr>
                                            <tr>
                                                <th>政治面貌</th>
                                                <td><input type="text" id="tPersonPoliticsStatus" name="tPersonPoliticsStatus"></td>
                                                <th>参加工作时间</th>
                                                <td><input type="text" id="tPersonTakeJobDate" name="tPersonTakeJobDate"></td>
                                            </tr>
                                            <tr>
                                                <th>调入时间</th>
                                                <td><input type="text" id="tPersonJoinWorkDate" name="tPersonJoinWorkDate"></td>
                                                <th>爱好</th>
                                                <td><input type="text" id="tPersonHobbay" name="tPersonHobbay"></td>
                                            </tr>
                                            <tr>
                                                <th>部门编号</th>
                                                <td><input type="text" id="tPersonDepartId" name="tPersonDepartId"></td>
                                                <th>单位编号</th>
                                                <td><input type="text" id="tPersonUnitId" name="tPersonUnitId"></td>
                                            </tr>
                                            <tr>
                                                <th>备注</th>
                                                <td colspan="3">
                                                    <textarea id="tPersonNotes" name="tPersonNotes" rows="3" cols="110"></textarea>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th colspan="4">
