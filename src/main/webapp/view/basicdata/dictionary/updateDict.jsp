    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <div class="content-wrapper">
                ...
                <form action="${webRoot}/dictController/update.do" method="post">
                    <table id="example1" class="table table-bordered table-striped">
                        <tr>
                            <th>模块</th>
                            <td>
                                <input type="hidden" id="dictionaryId" name="dictionaryId" value="${tBdDictionary.dictionaryId}" />
                                <input type="text" id="dictionaryCommonCata" name="dictionaryCommonCata"
                            value="${tBdDictionary.dictionaryCommonCata}"/>
                            </td>
                        </tr>
                        <tr>
                            <th>类型</th>
                            <td><input type="text" id="dictionaryDetailCata" name="dictionaryDetailCata"
                            value="${tBdDictionary.dictionaryDetailCata}"/></td>
                        </tr>

                        <tr>
                            <th>内容</th>
                            <td><input type="text" id="dictionaryContent" name="dictionaryContent"
                            value="${tBdDictionary.dictionaryContent}"/></td>
                        </tr>

                        <tr>
                            <th>排列顺序</th>
                            <td><input type="text" id="dictionaryOrder" name="dictionaryOrder"
                            value="${tBdDictionary.dictionaryOrder}"/></td>
                        </tr>
