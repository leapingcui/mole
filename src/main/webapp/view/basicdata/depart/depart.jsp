                            ...
                            <div class="box">
                                <div class="box-header">
                                    <button type="button" class="btn btn-block btn-default btn-lg" id="back"style="width: 10%"
                                            onclick="location.href='${webRoot}/departController/insertUI.do'">新增</button>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <c:forEach items="${tBdDeparts}" var="tBdDepart">
                                            <tr>
                                                <td>${tBdDepart.departName}</td>
                                                <td>${tBdDepart.departTelephone}</td>
                                                <td>${tBdDepart.departTelephone2}</td>
                                                <td>${tBdDepart.departFunction}</td>
                                                <td><a href="${webRoot}/departController/loadDepart.do?departId=${tBdDepart.departId}">详情</a> </td>
                                                <td><a href="${webRoot}/departController/updateUI.do?departId=${tBdDepart.departId}">编辑</a> </td>
                                                <td><a href="${webRoot}/departController/delete.do?departId=${tBdDepart.departId}"
