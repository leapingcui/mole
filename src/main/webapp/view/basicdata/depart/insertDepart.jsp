                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <form action="${webRoot}/departController/insert.do" method="post">
                                        <table id="example1" class="table table-bordered table-striped">
                                            <tr>
                                                <th>部门名称</th>
                                                <td><input id="departName" name="departName"></td>
                                            </tr>
                                            <tr>
                                                <th>电话</th>
                                                <td><input id="departTelephone" name="departTelephone"></td>
                                            </tr>
                                            <tr>
                                                <th>电话2</th>
                                                <td><input id="departTelephone2" name="departTelephone2"></td>
                                            </tr>
                                            <tr>
                                                <th>部门职能</th>
                                                <td><input id="departFunction" name="departFunction"></td>
                                            </tr>
                                            <tr>
                                                <th>备注</th>
                                                <td><input id="departNotes" name="departNotes"></td>
                                            </tr>
                                            <tr>
                                                <th>简介</th>
                                                <td></td>
