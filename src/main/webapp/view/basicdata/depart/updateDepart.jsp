                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <form action="${webRoot}/departController/update.do" method="post">
                                        <table id="example1" class="table table-bordered table-striped">
                                            <tr>
                                                <th>部门名称</th>
                                                <td>
                                                    <input type="hidden" id="departId" name="departId" value="${tBdDepart.departId}">
                                                    <input id="departName" name="departName" value="${tBdDepart.departName}"></td>
                                            </tr>
                                            <tr>
                                                <th>电话</th>
                                                <td><input id="departTelephone" name="departTelephone" value="${tBdDepart.departTelephone}"></td>
                                            </tr>
                                            <tr>
                                                <th>电话2</th>
                                                <td><input id="departTelephone2" name="departTelephone2" value="${tBdDepart.departTelephone2}"></td>
                                            </tr>
                                            <tr>
                                                <th>部门职能</th>
                                                <td><input id="departFunction" name="departFunction" value="${tBdDepart.departFunction}"></td>
                                            </tr>
                                            <tr>
                                                <th>备注</th>
                                                <td><input id="departNotes" name="departNotes" value="${tBdDepart.departNotes}"></td>
                                            </tr>
                                            <tr>
                                                <th>简介</th>
                                                <td></td>
